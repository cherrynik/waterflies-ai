import { getCurrentTime, getTimestamp } from '@waterflies/utils';
import { RecordingData, DownloadOptions, UploadOptions, ProcessingResult } from './types';
 ...
 */
export const generateRecordingFilename = (
  timestamp: string,
 ...
 */
export const triggerRecordingDownload = (
  blob: Blob,
  filename: string
): void => {
 ...
 */
export const logProcessingResult = (result: ProcessingResult): void => {
