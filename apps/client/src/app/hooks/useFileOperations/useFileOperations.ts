...
import { generateDefaultFilename, triggerDownload, createUploadFormData, handleUploadError, createStandardError } from './utils';
...
export function useFileOperations({
  ...
  const uploadFile = useCallback(async (blob: Blob, endpoint: string): Promise<Response> => {
    try {
